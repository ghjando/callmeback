...
async function main() {
  ...
  */
  ...
  app.get('/booking_remind', async (req, res) => {
    //res.render('booking_remind', {booking_data:'陳筱玲(11月2日 09:30, 18號)'});
    
    let booking_data = req.query.booking_data;
    //let qrcode_url = `https://line.me/R/oaMessage/@callmeback/?預約提醒:${booking_data} 🔔 請發送此訊息，完成提醒設定`;
    ...
    //res.render('booking_remind', {booking_data:booking_data, image_url:image_url});
    res.render('booking_remind', {booking_data:booking_data});
  });
  ...
  app.get('/booking_remind_pc', async (req, res) => {
    ...
    const opts = {margin:3, maskPattern:0, errorCorrectionLevel:'L', scale:5, color:{dark:"#06C755",light:"#FFFFFF"}};
    let image_url = await QRCode.toDataURL(qrcode_url, opts);
    res.render('booking_remind_pc', {booking_data:booking_data, image_url:image_url});
  });
